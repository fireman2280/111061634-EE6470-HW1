...
public:
  sc_in_clk i_clk;
  sc_out<bool> o_rst;
  sc_fifo_out<unsigned char> o_mean_r;
  sc_fifo_out<unsigned char> o_mean_g;
  sc_fifo_out<unsigned char> o_mean_b;
  sc_fifo_out<unsigned char> o_med_r;
  sc_fifo_out<unsigned char> o_med_g;
  sc_fifo_out<unsigned char> o_med_b;

  sc_fifo_in<int> i_mean_result_r;
  sc_fifo_in<int> i_mean_result_g;
  sc_fifo_in<int>i_mean_result_b;
  sc_fifo_in<int> i_med_result_r;
  sc_fifo_in<int> i_med_result_g;
  sc_fifo_in<int> i_med_result_b;
  ...
  unsigned char *get_temp_image() { return temp_bitmap; }
